/* podred.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int podred_(integer *n, integer *loc, doublereal *pod)
{
    ...
    extern /* Subroutine */ int chkin_(char *, ftnlen), scardd_(integer *, 
	    doublereal *), remlad_(integer *, integer *, doublereal *, 
	    integer *), podond_(doublereal *, integer *, integer *);
