/* ncoded.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int ncoded_0_(int n__, integer *value, doublereal *item)
{
...
/*     Encode an integer value into a double precision item. */
...
/*     ITEM        is a double precision item, into which the value has */
...
/*     Decode the integer value stored in a double precision item by a */
/*     previous call to NCODED. */
...
/*     ITEM        is a double precision item, into which an integer */
/*                 value has been encoded by a previous call to NCODED. */
...
/*     Standard SPICE error handling. */
	...
	chkin_("DCODED", (ftnlen)6);
    }
    *value = (integer) (*item);
    chkout_("DCODED", (ftnlen)6);
    return 0;
} /* ncoded_ */

/* Subroutine */ int ncoded_(integer *value, doublereal *item)
{
    return ncoded_0_(0, value, item);
    }

/* Subroutine */ int dcoded_(doublereal *item, integer *value)
{
    return ncoded_0_(1, value, item);
    }
