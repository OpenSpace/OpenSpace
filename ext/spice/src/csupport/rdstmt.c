/* rdstmt.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int rdstmt_(char *prmpt, char *delim, char *stmt, ftnlen 
	prmpt_len, ftnlen delim_len, ftnlen stmt_len)
{
    ...
    /* Local variables */
    char line[132], space[1];
    integer prlen;
    extern integer rtrim_(char *, ftnlen);
    char myprm[132];
    extern /* Subroutine */ int replch_(char *, char *, char *, char *, 
	    ftnlen, ftnlen, ftnlen, ftnlen), dmpbuf_(void), suffix_(char *, 
	    integer *, char *, ftnlen, ftnlen), rstbuf_(void), putbuf_(char *,
	     ftnlen), prompt_(char *, char *, ftnlen, ftnlen);
    char tab[1];
    integer end;
