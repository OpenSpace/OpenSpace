...
/* Subroutine */ int syptri_(char *name__, char *symnam, integer *symptr, 
	integer *symval, integer *ptr, integer *n, logical *found, ftnlen 
	name_len, ftnlen symnam_len)
{
...
/*           CALL SYPTRI ( NAME, SYMNAM, SYMPTR, SYMVAL, PTR, N, FOUND ) */
