/* nicepr_1.f -- translated by f2c (version 19980913).
...
/* $Procedure     NICEPR_1 ( Nicely printed output -- test version ) */
/* Subroutine */ int nicepr_1__(char *string, char *style, S_fp myio, ftnlen 
	string_len, ftnlen style_len)
{
...
/*     MYIO       I   A routine that handles output */
...
/*     MYIO      Is a routine that takes a single string as input and */
/*               appropriately outputs the string.  It should be declared */
...
/* -     Test Utility Version 2.0.0, 7-APR-1995 (WLT) */

/*         The routine was updated to fixed DO WHILE loop problems */
/*         caused by accessing characters past the end of the string. */
...
/*     Parse the style string. */
	...
	if (vb != 0) {
		...
		if (s_cmp(errorr, " ", (ftnlen)160, (ftnlen)1) != 0) {
		    ...
		    errch_("#", errorr, (ftnlen)1, (ftnlen)160);
		    sigerr_("SPICE(NONNUMERICSTRING)", (ftnlen)23);
		    chkout_("NICEPR_1", (ftnlen)8);
		    return 0;
		}
