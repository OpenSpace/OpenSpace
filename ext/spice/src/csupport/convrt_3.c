...
/*        CLASSS, and EXPONT pod.  Why ask why?  Well in this case */
...
/*              If we have a left parenthesis ... */
		...
		if (ident[(i__2 = i__ - 1) < 128 && 0 <= i__2 ? i__2 : s_rnge(
			"ident", i__2, "convrt_3__", (ftnlen)463)] == lparen) 
			{
...
/*                 Append the operation to the current group. */
		    ...
		    appndd_(&opval[(i__3 = ident[(i__2 = i__ - 1) < 128 && 0 
			    ...
			    "__", (ftnlen)492)] - 1) < 6 && 0 <= i__3 ? i__3 : 
			    s_rnge("opval", i__3, "convrt_3__", (ftnlen)492)],
			     parsed);
		    appndi_(&c_n1, classs);
		    appndd_(&c_b28, expont);
...
/*              ...or if we have a unit or number ... */
			...
			s_rnge("ident", i__2, "convrt_3__", (ftnlen)499)] == 
			0) {
...
/*                  append them to the current group. */
		    ...
		    b = beg[(i__2 = i__ - 1) < 128 && 0 <= i__2 ? i__2 : 
			    s_rnge("beg", i__2, "convrt_3__", (ftnlen)505)];
		    e = end[(i__2 = i__ - 1) < 128 && 0 <= i__2 ? i__2 : 
			    s_rnge("end", i__2, "convrt_3__", (ftnlen)506)];
		    if (inout == 1) {
		    ...
		    appndd_(&dim[(i__2 = class__) < 6 && 0 <= i__2 ? i__2 : 
			    s_rnge("dim", i__2, "convrt_3__", (ftnlen)520)], 
			    expont);
...
/*              of value/operation pairs. */
			...
			s_rnge("ident", i__2, "convrt_3__", (ftnlen)529)] == 
			rparen) {
...
/*                 Next handle multiplication and division. */
			...
			class__ = classs[(i__2 = r__ + 5) < 134 && 0 <= i__2 ?
				 i__2 : s_rnge("classs", i__2, "convrt_3__", (
				ftnlen)641)];
			if (parsed[(i__2 = j + 5) < 134 && 0 <= i__2 ? i__2 : 
				s_rnge("parsed", i__2, "convrt_3__", (ftnlen)
				643)] == 1.) {
			    parsed[(i__2 = active + 5) < 134 && 0 <= i__2 ? 
				    i__2 : s_rnge("parsed", i__2, "convrt_3__"
				    , (ftnlen)645)] = parsed[(i__3 = active + 
				    5) < 134 && 0 <= i__3 ? i__3 : s_rnge(
				    "parsed", i__3, "convrt_3__", (ftnlen)645)
				    ] * parsed[(i__4 = r__ + 5) < 134 && 0 <= 
				    i__4 ? i__4 : s_rnge("parsed", i__4, 
				    "convrt_3__", (ftnlen)645)];
			    dimen[(i__2 = class__) < 6 && 0 <= i__2 ? i__2 : 
				    s_rnge("dimen", i__2, "convrt_3__", (
				    ftnlen)646)] = dimen[(i__3 = class__) < 6 
				    && 0 <= i__3 ? i__3 : s_rnge("dimen", 
				    i__3, "convrt_3__", (ftnlen)646)] + 
				    expont[(i__4 = r__ + 5) < 134 && 0 <= 
				    i__4 ? i__4 : s_rnge("expont", i__4, 
				    "convrt_3__", (ftnlen)646)];
			} else if (parsed[(i__2 = j + 5) < 134 && 0 <= i__2 ? 
				i__2 : s_rnge("parsed", i__2, "convrt_3__", (
				ftnlen)648)] == 2.) {
			    parsed[(i__2 = active + 5) < 134 && 0 <= i__2 ? 
				    i__2 : s_rnge("parsed", i__2, "convrt_3__"
				    , (ftnlen)650)] = parsed[(i__3 = active + 
				    5) < 134 && 0 <= i__3 ? i__3 : s_rnge(
				    "parsed", i__3, "convrt_3__", (ftnlen)650)
				    ] / parsed[(i__4 = r__ + 5) < 134 && 0 <= 
				    i__4 ? i__4 : s_rnge("parsed", i__4, 
				    "convrt_3__", (ftnlen)650)];
			    dimen[(i__2 = class__) < 6 && 0 <= i__2 ? i__2 : 
				    s_rnge("dimen", i__2, "convrt_3__", (
				    ftnlen)651)] = dimen[(i__3 = class__) < 6 
				    && 0 <= i__3 ? i__3 : s_rnge("dimen", 
				    i__3, "convrt_3__", (ftnlen)651)] - 
				    expont[(i__4 = r__ + 5) < 134 && 0 <= 
				    i__4 ? i__4 : s_rnge("expont", i__4, 
