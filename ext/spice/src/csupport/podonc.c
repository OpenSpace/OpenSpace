/* podonc.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int podonc_(char *pod, integer *offset, integer *number, 
	ftnlen pod_len)
{
...
/*     indicates the end of the active group. */
    ...
    dcodec_(pod + pod_len * 3, offset, pod_len);
    *number = cardc_(pod, pod_len) - *offset;
    chkout_("PODONC", (ftnlen)6);
    return 0;
} /* podonc_ */
