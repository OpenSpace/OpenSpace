/* podbed.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int podbed_(doublereal *pod, integer *begin, integer *end)
{
    extern /* Subroutine */ int chkin_(char *, ftnlen), podond_(doublereal *, 
	    integer *, integer *);
