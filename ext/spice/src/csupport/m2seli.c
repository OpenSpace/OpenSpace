/* m2seli.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int m2seli_(char *name__, char *string, integer *nth, 
...
/*     template word and parse it as an integer. */
