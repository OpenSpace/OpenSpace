...
/* Subroutine */ int m2seld_(char *name__, char *string, integer *nth, 
	logical *found, doublereal *dp, ftnlen name_len, ftnlen string_len)
{
    /* Builtin functions */
    integer i_len(char *, ftnlen), s_cmp(char *, char *, ftnlen, ftnlen);

    /* Local variables */
    static doublereal mydp;
...
/*                of STRING that was the NTH match with the NAMEd META/2 */
/*                template word. */
...
/*     Extract n'th number matching a named template word */
