/* m2getc.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int m2getc_(char *name__, char *string, logical *found, char 
...
/*     Extract first word matching a named template word */
