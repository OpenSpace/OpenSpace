/* podegi.f -- translated by f2c (version 19980913).
...
/* $Procedure      PODEGI ( Pod, end group, integer ) */
/* Subroutine */ int podegi_(integer *pod)
{
