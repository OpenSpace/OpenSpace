...
/*                    the number of Chebyshev coefficients per */
/*                    coordinate minus one. POLYDG must not exceed */
/*                    MAXDEG (see Parameters below). */
...
/*            CALL SPKW02 ( HANDLE, 301,    3,      'J2000', */
...
/* -    SPICELIB Version 1.0.0, 1-AUG-1995 (KSZ) */
