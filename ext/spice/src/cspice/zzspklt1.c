...
/* $Procedure ZZSPKLT1 ( S/P Kernel, light time corrected state ) */
/* Subroutine */ int zzspklt1_(integer *targ, doublereal *et, char *ref, char 
...
/*     one-way light time. */
    ...
    zzspkgo1_(targ, et, ref, &c__0, ssbtrg, &ssblt, ref_len);
...
/*     compute the light time. */
	...
	d__1 = *et + ltsign * *lt;
	zzspkgo1_(targ, &d__1, ref, &c__0, ssbtrg, &ssblt, ref_len);
	vsubg_(ssbtrg, stobs, &c__6, starg);
