/* zzekrd01.f -- translated by f2c (version 19980913).
...
/*     Class 1 columns contain scalar integer values. */
...
/*     This routine is a utility for reading data from class 1 columns. */
