/* remlad.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int remlad_(integer *ne, integer *loc, doublereal *array, 
	integer *na)
{
...
/*     remove elements from a d.p. array */
