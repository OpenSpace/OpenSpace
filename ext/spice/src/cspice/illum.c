...
/*                                     corrections.  This is the same as */
/*                                     LT corrections but with further */
/*                                     iterations to a converged */
/*                                     Newtonian light time solution. */
/*                                     Given that relativistic effects */
/*                                     may be as large as the higher */
/*                                     accuracy achieved by this */
/*                                     computation, this is correction */
/*                                     is seldom worth the additional */
/*                                     computations required unless the */
/*                                     user incorporates additional */
/*                                     relativistic corrections.  Both */
/*                                     the state and rotation of the */
/*                                     target body are corrected for */
/*                                     light time. */

/*                          'CN+S'     Converged Newtonian light time */
/*                                     corrections and stellar */
/*                                     aberration. Both the state and */
