/* zzspkpa0.f -- translated by f2c (version 19980913).
...
/* $Procedure ZZSPKPA0 ( S/P Kernel, apparent position only ) */
/* Subroutine */ int zzspkpa0_(integer *targ, doublereal *et, char *ref, 
...
/*        3) Obtain an uncorrected position vector derived directly from */
/*           data in an SPK file: */
...
/*        ZZSPKPA0 begins by computing the geometric position T(ET) of */
...
/*        selected, ZZSPKPA0 computes the position of the target body at */
...
/*        selected, ZZSPKPA0 computes the position of the target body T */
...
/*     In the following code fragment, SPKSSB and ZZSPKPA0 are used */
...
/*           CALL ZZSPKPA0 (  IO,    EPOCH, 'J2000', STVGR2, */
/*       .                 'LT+S', STIO,   LT              ) */
...
/*     2) The ephemeris files to be used by ZZSPKPA0 must be loaded */
/*        (normally by the SPICELIB kernel loader FURNSH) before */
/*        this routine is called. */

/*     3) Unlike most other SPK position computation routines, this */
...
/*        Based on SPICELIB Version 2.0.1, 20-OCT-2003 (EDW) */
...
/*     light time. */
    ...
    zzspkgp0_(targ, et, ref, &c__0, ptarg, lt, ref_len);
...
/*     the observer remains where he is. */
	...
	d__1 = *et + ltsign * *lt;
	zzspkgp0_(targ, &d__1, ref, &c__0, ptarg, lt, ref_len);
	vsub_(ptarg, sobs, tpos);
	vequ_(tpos, ptarg);
	*lt = vnorm_(ptarg) / clight_();
    }
