...
/*    C        compose two transformations: that from IAU_MARS to */
/*    C        J2000 at TRGEPC, followed by the transformation from */
/*    C        J2000 to MRO_HIRISE_LOOK_DIRECTION at ET. */
/*    C        (We could use any other inertial frame in place */
/*    C        of J2000; the result would be the same.) */
/*    C */
...
/*             CALL PXFORM ( 'IAU_MARS', 'J2000', TRGEPC, R1 ) */
/*             CALL PXFORM ( 'J2000',    HIREF,   ET,     R2 ) */

/*             CALL MXM ( R2,    R1,     XFORM  ) */
