	...
	ftnlen fixref_len, ftnlen abcorr_len, ftnlen obsrvr_len)
{
    ...
    doublereal altsun, corpos[3];
    extern logical return_(void);
    doublereal obspos[3], prevet, prevlt, ssbost[6], ssbtst[6];
    ...
    extern /* Subroutine */ int setmsg_(char *, ftnlen), sigerr_(char *, 
	    ...
	    ftnlen, ftnlen, ftnlen), lparse_(char *, char *, integer *, 
	    integer *, char *, ftnlen, ftnlen, ftnlen), spkezp_(integer *, 
	    doublereal *, char *, char *, integer *, doublereal *, doublereal 
	    *, ftnlen, ftnlen), vminus_(doublereal *, doublereal *), nearpt_(
...
/*    C */
/*    C     Compute sub-solar point using light time and stellar */
...
/*    C        center of the target at TRGEPC. Express the Sun's */
/*    C        location in planetographic coordinates. */
/*    C */
/*             CALL SPKPOS ( 'SUN',  TRGEPC, 'IAU_MARS', 'LT+S', */
/*         .                 'MARS', SUNPOS, SUNLT              ) */
...
/*       Sub-solar planetographic longitude (deg) =         175.810721566 */
/*       Sun's planetographic longitude     (deg) =         175.810721564 */
/*       Sub-solar planetographic latitude  (deg) =          23.668550265 */
/*       Sun's planetographic latitude      (deg) =          23.420823346 */
/*       Sub-solar planetocentric longitude (deg) =        -175.810721566 */
/*       Sun's planetocentric longitude     (deg) =        -175.810721564 */
/*       Sub-solar planetocentric latitude  (deg) =          23.420819920 */
/*       Sun's planetocentric latitude      (deg) =          23.420819920 */


/*      Computation method = Near point: ellipsoid */

/*       Sub-solar point altitude            (km) =           0.000000000 */
/*       Sub-solar planetographic longitude (deg) =         175.810721552 */
/*       Sun's planetographic longitude     (deg) =         175.810721550 */
/*       Sub-solar planetographic latitude  (deg) =          23.420823346 */
/*       Sun's planetographic latitude      (deg) =          23.420823346 */
/*       Sub-solar planetocentric longitude (deg) =        -175.810721552 */
/*       Sun's planetocentric longitude     (deg) =        -175.810721550 */
/*       Sub-solar planetocentric latitude  (deg) =          23.175085562 */
/*       Sun's planetocentric latitude      (deg) =          23.420819920 */
...
/*           Find the position of the Sun as seen from the */
/*           target at TRGEPC. */
...
/*           SPOINT, the observer altitude ALT, the target epoch TRGEPC, */
