/* fmtint.f -- translated by f2c (version 19980913).
...
/* Subroutine */ int fmtint_(integer *intval, char *format, char *string, 
...
/*     Standard SPICE error handling. */
	...
	chkin_("FMTINT", (ftnlen)6);
    }
    d__1 = (doublereal) (*intval);
    dpfmt_(&d__1, format, tmpstr, format_len, (ftnlen)132);
