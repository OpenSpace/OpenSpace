...
export const TransferFunctionKey = 'GalaxyVolume.renderable.TransferFunctionHandler.TransferFunction';
export const UnitKey = 'GalaxyVolume.renderable.TransferFunctionHandler.DataUnit';
export const MinKey = 'GalaxyVolume.renderable.TransferFunctionHandler.MinValue';
export const MaxKey = 'GalaxyVolume.renderable.TransferFunctionHandler.MaxValue';
// key for setting/getting the histogram (focus) node
export const HistogramKey = 'GalaxyVolume.renderable.TransferFunctionHandler.Histogram';
