registerFunction(
  {
    ...
    Function = function(layerName, resolution, format)
...
registerFunction(
  {
    ...
    Function = function(layerName, date, resolution, format)
      local tileLevel = 5
...
registerFunction(
  {
    ...
    Function = function(layerName, resolution, format, startDate, endDate)
...
registerFunction(
  {
    ...
    Function = function(dir, node_name)
...
registerFunction(
  {
    ...
    Function = function(name, globe_identifier, lat, long, altitude)
