...
// codegen.exe -file A:\OpenSpace\modules\atmosphere\rendering\renderableatmosphere.cpp
...
,Optional::No,"A list of objects that cast light on this atmosphere"});
    ...
    codegen_Parameters_Ozone_Coefficients->documentations.push_back({"Extinction",new DoubleVector4Verifier,Optional::Yes,""});
