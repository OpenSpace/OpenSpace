  ...
  "actions": [
    {
      ...
      "script": "openspace.setPropertyValueSingle('Scene.Skycamera_sphere.Renderable.Enabled', true);openspace.setPropertyValueSingle('Scene.Earth.Renderable.Layers.NightLayers.Earth_at_Night_2012.Enabled', true);openspace.setPropertyValueSingle('Scene.Earth.Renderable.Layers.ColorLayers.Oval_North.Enabled', false);openspace.setPropertyValueSingle('Scene.Earth.Renderable.Layers.ColorLayers.Oval_South.Enabled', false);openspace.setPropertyValueSingle('ScreenSpace.color-legend-aurora-oval.Enabled', false);openspace.setPropertyValueSingle('ScreenSpace.Legend-aurora-oval.Enabled', false);openspace.setPropertyValueSingle('ScreenSpace.ScreenSpaceKPindex.Enabled', false);openspace.setPropertyValueSingle('ScreenSpace.target-marker.Enabled', false);openspace.setPropertyValueSingle('NavigationHandler.OrbitalNavigator.FollowAnchorNodeRotationDistance', 16.360000);openspace.scriptScheduler.clear();openspace.time.setDeltaTime(300);openspace.time.setTime('2024-MAY-11 04:22:00.00');Endtime2012 = \"2024 MAY 11 09:53:00\";Starttimescript12 = \"openspace.time.setTime('2024 MAY 11 04:22:00')\";openspace.scriptScheduler.loadScheduledScript(Endtime2012, Starttimescript12);"
    }
  ],
  "assets": [
    "base",
